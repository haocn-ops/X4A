...
export const messages = defineMessages({
  ...
  public_long: {
    ...
    defaultMessage: 'Anyone on and off x4ai',
  },
  unlisted_short: {
  ...
  unlisted_long: {
    ...
    defaultMessage:
      'Hidden from x4ai search results, trending, and public timelines',
  },
  ...
  unlisted_extra: {
    ...
    defaultMessage:
      'This behaves exactly like public, except the post will not appear in live feeds or hashtags, explore, or x4ai search, even if you are opted-in account-wide.',
  },
});
