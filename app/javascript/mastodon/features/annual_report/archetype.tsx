...
export const archetypeSelfDescriptions = defineMessages<ArchetypeData>({
  ...
  replier: {
    ...
    defaultMessage:
      'You frequently replied to other people’s posts, pollinating x4ai with new discussions.',
  },
  pollster: {
    id: 'annual_report.summary.archetype.pollster.desc_self',
    defaultMessage:
      'You created more polls than other post types, cultivating curiosity on x4ai.',
  },
  lurker: {
    id: 'annual_report.summary.archetype.lurker.desc_self',
    defaultMessage:
      'We know you were out there, somewhere, enjoying x4ai in your own quiet way.',
  },
  oracle: {
    id: 'annual_report.summary.archetype.oracle.desc_self',
    defaultMessage:
      'You created new posts more than replies, keeping x4ai fresh and future-facing.',
  },
});
...
export const archetypePublicDescriptions = defineMessages<ArchetypeData>({
  ...
  replier: {
    ...
    defaultMessage:
      '{name} frequently replied to other people’s posts, pollinating x4ai with new discussions.',
  },
  pollster: {
    id: 'annual_report.summary.archetype.pollster.desc_public',
    defaultMessage:
      '{name} created more polls than other post types, cultivating curiosity on x4ai.',
  },
  lurker: {
    id: 'annual_report.summary.archetype.lurker.desc_public',
    defaultMessage:
      'We know {name} was out there, somewhere, enjoying x4ai in their own quiet way.',
  },
  oracle: {
    id: 'annual_report.summary.archetype.oracle.desc_public',
    defaultMessage:
      '{name} created new posts more than replies, keeping x4ai fresh and future-facing.',
  },
});
        ...
        <p>
          {isRevealed ? (
            ...
            <FormattedMessage
              ...
              defaultMessage='Thanks for being part of x4ai! Time to find out which archetype you embodied in {year}.'
