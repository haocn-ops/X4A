  ...
  if (visibility === 'private') {
    hintText = (
      <FormattedMessage
        ...
        defaultMessage="Follower-only posts authored on x4ai can't be quoted by others."
      />
    );
  }
  ...
  if (visibility === 'direct') {
    hintText = (
      <FormattedMessage
        ...
        defaultMessage="Private mentions authored on x4ai can't be quoted by others."
      />
    );
  }
